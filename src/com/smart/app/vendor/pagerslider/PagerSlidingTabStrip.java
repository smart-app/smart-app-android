...
package com.smart.app.vendor.pagerslider;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int tabBackgroundResId = R.drawable.pager_slider_background_tab;
	...
	public void setTabsStyle(DisplayMetrics dm, String defaultHexColor, String selectedHexColor) {
		// 设置Tab是自动填充满屏幕的
		...
		this.setTextColor(Color.parseColor(defaultHexColor));
		// 设置Tab Indicator的颜色
		this.setIndicatorColor(Color.parseColor(selectedHexColor));
		// 设置选中Tab文字的颜色 (这是我自定义的一个方法)
		this.setSelectedTextColor(Color.parseColor(selectedHexColor));
		// 取消点击Tab时的背景色
